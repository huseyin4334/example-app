...
public class Route {
    ...
    public void setBeforeFlight(Transportation beforeFlight) {
        if (beforeFlight.getTransportationType().getName().equals("FLIGHT"))
    ...
    public void setFlight(Transportation flight) {
        ...
        if (!flight.getTransportationType().getName().equals("FLIGHT"))
    ...
    public void setAfterFlight(Transportation afterFlight) {
        ...
        if (afterFlight.getTransportationType().getName().equals("FLIGHT"))
